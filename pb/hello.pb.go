...
const file_hello_proto_rawDesc = "" +
	...
	"\tCheckUser\x12\x0f.pb.UserRequest\x1a\x15.pb.CheckUserResponse2\x8c\x01\n" +
	"\rCourseService\x12<\n" +
...
var file_hello_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_hello_proto_goTypes = []any{
	...
	(*CheckUserResponse)(nil),     // 11: pb.CheckUserResponse
	(*SaveUserResponse)(nil),      // 12: pb.SaveUserResponse
}
var file_hello_proto_depIdxs = []int32{
	...
	4,  // 3: pb.AuthService.CheckUser:input_type -> pb.UserRequest
	4,  // 4: pb.CourseService.GetUserSections:input_type -> pb.UserRequest
	2,  // 5: pb.CourseService.AddSection:input_type -> pb.SaveSectionRequest
	0,  // 6: pb.PaymentService.CreatePayment:input_type -> pb.CreatePaymentRequest
	7,  // 7: pb.AuthService.Login:output_type -> pb.LoginResponse
	9,  // 8: pb.AuthService.VerifyToken:output_type -> pb.VerifyResponse
	12, // 9: pb.AuthService.Register:output_type -> pb.SaveUserResponse
	11, // 10: pb.AuthService.CheckUser:output_type -> pb.CheckUserResponse
	5,  // 11: pb.CourseService.GetUserSections:output_type -> pb.UserSectionsResponse
	3,  // 12: pb.CourseService.AddSection:output_type -> pb.SaveSectionResponse
	1,  // 13: pb.PaymentService.CreatePayment:output_type -> pb.CreatePaymentResponse
